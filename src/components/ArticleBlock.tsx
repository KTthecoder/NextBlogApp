...
const ArticleBlock = ({ title, commentsCount, likesCount, banner, shortDesc, categoryColor, category, createdAt, slug, user }: Props) => {
  return (
    <Link href={slug.toString()} className='flex flex-col w-full'>
        ...
        <p className='text-gray-200 tracking-wide mt-4 flex flex-row items-center'>
